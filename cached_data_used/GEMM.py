...
def tune(device_name, strategy="bayes_opt_GPyTorch_lean", strategy_options=None, verbose=False, quiet=True, simulation_mode=True):
    ...
    results, env = kernel_tuner.tune_kernel("Xgemm", kernel_string, problem_size, args, tune_params, block_size_names=block_size_names, lang="OpenCL",
                                            ...
                                            platform=0, metrics=metrics, iterations=32, cache="cache_files/GEMM_" + device_name, strategy=strategy,
