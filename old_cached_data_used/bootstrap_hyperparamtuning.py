...
def tune(strategy="bayes_opt_GPyTorch_lean", iterations=112, strategy_options=None):
    ...
    metrics = OrderedDict()
    strategy_options = {}
    strategy_options['max_fevals'] = 2000
    ...
    # strategy_options['popsize'] = 1

    # # # test precision
    # tune_params = OrderedDict()
    # tune_params["max_fevals"] = [220]
    # tune_params["dummy_param"] = [1, 2, 3, 4, 5, 6, 7, 8]
    ...
    # strategy_options['popsize'] = strategy_options['max_fevals']

    # setup tunable parameters
    tune_params = OrderedDict()
    tune_params["max_fevals"] = [220]
    tune_params["initialsamplemethod"] = ['lhs', 'index']
    tune_params["initialsamplerandomoffsetfactor"] = [0.01, 0.05, 0.1, 0.2]
    ...
    tune_params["likelihood"] = ['Gaussian', 'FixedNoise']
    tune_params["optimizer"] = ['LBFGS']    # 'Adam', 'AdamW', 'ASGD'
    tune_params["initial_training_iter"] = [5, 10, 25, 50]
    tune_params["training_after_iter"] = [0, 1, 3, 10]
    ...
    results, env = tune_kernel(prog_name + "_kernel", prog_name + "_kernel.py", problem_size, args, tune_params, lang='Python', iterations=iterations,
                               ...
                               simulation_mode=simulation_mode, parallel_mode=parallel_mode, hyperparam_mode=hyperparam_mode, cache="cache_files/" + prog_name,
                               observers=[])
