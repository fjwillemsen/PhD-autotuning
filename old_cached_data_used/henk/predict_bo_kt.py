...
def tune(device_name, strategy="bayes_opt_GPyTorch_lean", strategy_options=None, verbose=True, quiet=False, simulation_mode=True):
    ...
    results, env = tune_kernel("predict_peak_mem", "predict_peak_mem_kernel.py", problem_size=1, iterations=1, arguments=[], tune_params=tune_params, restrictions=restrict, verbose=verbose, quiet=quiet, cache=f"../cache_files/predict_peak_mem_{device_name}", strategy=strategy,
